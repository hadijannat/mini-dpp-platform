...
|-------------|-------|--------|--------|----------|
| Pipeline Map | Role 0 | Phase 6 | ⏳ PENDING | docs/internal/audits/pipeline-map-2026-02-10.md |
| Findings Register | Role 0 | Phase 6 | ⏳ PENDING | docs/internal/audits/findings-register-2026-02-10.md |
| Alignment Matrix | Role 0 | Phase 6 | ⏳ PENDING | docs/internal/audits/alignment-matrix-2026-02-10.md |
| Execution Plan | Role 0 | Phase 6 | ⏳ PENDING | docs/internal/audits/remediation-epics-2026-02-10.md |

## Expert Reports Status

| Report | Expert | Due Phase | Status | Location |
|--------|--------|-----------|--------|----------|
| 01_idta_smt_specialist.md | Role 1 | Phase 2 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 02_template_versioning.md | Role 2 | Phase 2 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 03_parser_schema.md | Role 3 | Phase 2 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 04_frontend_forms.md | Role 4 | Phase 4 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 05_basyx_export.md | Role 5 | Phase 3 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 06_persistence_integrity.md | Role 6 | Phase 3 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 07_security_tenancy.md | Role 7 | Phase 5 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
| 08_qa_automation.md | Role 8 | Phase 5 | ⏳ PENDING | docs/internal/reviews/expert-reports/ |
...
- `docs/internal/evidence/README.md` - Evidence directory documentation
- `docs/internal/audits/inspection-guide.md` - Comprehensive setup guide

✅ **Directories**:
- `evidence/` - Artifact collection (gitignored)
- `backend/tests/inspection/` - Expert-specific tests
- `docs/internal/reviews/expert-reports/` - Will be created during Phase 2-5
