...
export default function StandardsMapSection() {
  return (
    <section className="bg-landing-surface-1/45 px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-7 grid gap-4 lg:grid-cols-2">
          {landingContent.standardsMap.map((row) => (
            <article
              key={row.title}
              className="rounded-2xl border border-landing-ink/12 bg-white/78 p-5 shadow-[0_20px_40px_-34px_rgba(16,35,50,0.78)]"
            >
